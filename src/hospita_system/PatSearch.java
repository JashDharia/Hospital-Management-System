...
public class PatSearch {
    ...
    JTable table = new JTable(new DefaultTableModel(new Object[]{"id","aadhar no", "name","in date","out date"}, 0));
        ...
        searc.addActionListener(new ActionListener() {
        	...
        	public void actionPerformed(ActionEvent arg0) {
        		...
        		try{
        			...
        			ResultSet rs;
        			if(name==" ") {
        			rs=stmt.executeQuery("select * from patients where fullName='"+name+"'");  
        			}
        			else {
        		...
        		//"id","aadhar no", "name","in date","out date"}
        			...
        			{     
        				...
        				model.addRow(new Object[] {id,namesa,spec,in,out});
        			}
